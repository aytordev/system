...
function generateMarkdown(
  ...
  let md = `# Interface Design Guidelines\n\n`;
  ...
  md += `> interface elements. Humans may also find it useful, but guidance here  \n`;
  md += `> is optimized for automation and consistency by AI-assisted workflows.\n\n`;
  md += `---\n\n`;
  md += `## Abstract\n\n`;
  ...
  try {
    ...
    try {
      ...
      metadata = {
        ...
        abstract: "Interface design skill for crafted UI.",
      };
    }
