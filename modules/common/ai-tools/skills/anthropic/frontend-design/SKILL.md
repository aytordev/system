...
description: Create distinctive, production-grade frontend interfaces with high design quality. Use this skill when the user asks to build web components, pages, or programs. Generates creative, polished code that avoids generic AI aesthetics.
