  ...
  nix-module-coder = {
    ...
    content = ''
      ...
      **Important reminders:**
      ...
      - Consider the aytordev-specific patterns and namespace conventions
      ...
      **REMINDER:**
      Focus on creating modules that are robust, user-friendly, and maintainable while following established NixOS/Home Manager conventions and the specific patterns used in aytordev.
    '';
  };
}
