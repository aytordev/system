{
  module-scaffold = ''
    ...
    **Project type detection:**
    - Check if we're in aytordev repository (look for specific directory structure)
    ...
    **Pattern documentation:**
    ...
    ```
    IF aytordev project detected:
        Launch Task with Dotfiles Expert: "Provide aytordev module scaffolding patterns including namespace conventions, option organization, library usage, and template structures for [MODULE_TYPE] modules"
    ELSE:
