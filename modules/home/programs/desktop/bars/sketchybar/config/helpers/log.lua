...
local function write_log(level, module, msg, ...)
	...
	local line =
		string.format("%s [%-5s] [%s] %s\n", os.date("%Y-%m-%d %H:%M:%S"), level, module or "general", formatted)
...
function M.debug(msg, ...)
	write_log("DEBUG", nil, msg, ...)
end
function M.info(msg, ...)
	write_log("INFO", nil, msg, ...)
end
function M.warn(msg, ...)
	write_log("WARN", nil, msg, ...)
end
function M.error(msg, ...)
	write_log("ERROR", nil, msg, ...)
end
