      ...
      profiles =
        let
          ...
          commonSettings = {
            ...
            # Debug
            "debug.console.fontFamily" = lib.mkForce "Maple Mono, MapleMono, monospace";
            ...
            "editor.inlayHints.fontFamily" = lib.mkForce "Maple Mono, MapleMono, monospace";
            ...
            "editor.fontFamily" =
              lib.mkForce "Maple Mono, MapleMono, monospace";
            "editor.codeLensFontFamily" =
              lib.mkForce "Maple Mono, MapleMono, monospace";            "editor.fontLigatures" = true;
            "editor.fontSize" = 16;
            ...
            "errorLens.fontFamily" = "Maple Mono, MapleMono, monospace";
