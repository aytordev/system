...
in {
  ...
  */
  ...
  : 2\. Function argument
  */
  importDirPlain = dirPath: exclude: let
    excludeList =
      if builtins.isList exclude
      then exclude
      else [];
  ...
  */
  ...
  : 1\. Function argument
  */
  importModulesRecursive = dirPath: let
    # Helper function to recursively walk directories
    walkDir = currentPath: let
  ...
  : 1\. Function argument
  */
  parseSystemConfigurations = systemsPath: let
